...
while (true) {
    medioCotizacion = prompt(
        "Bienvenido/a " +
        nombre +
        " ingresa 1 si quieres recibir atencion por WhatsApp o ingresa 2 si quieres generar tu cotizacion Online"
    );
...
while (true) {
    if (medioCotizacion == 1) {
        alert(
            "Nuestro numero de WhatsApp es: 3382456789, recuerda que tambien puedes acercarte a nuestras oficinas en Mitre 887 Rosario, Santa fe"
        );
        break;
...
if (comboDescuento1 == 1 && comboDescuento2 == 1) {
    ...
    alert(
        "Por contratar ambos servicios con nosotros te hacemos un descuento del 20%, el total a pagar te queda en: $" +
        precioConDescuento
    );
}
